...
namespace World_Server.Game.Entitys
{
    public class PlayerEntity : WorldObject
    {
        ...
        public PlayerEntity(Character character) : base((int)EUnitFields.PLAYER_END - 0x4)
        {
            ...
            SetUpdateField<Int32>((int)EUnitFields.UNIT_FIELD_DISPLAYID, GetModel(character));               // 
            SetUpdateField<Int32>((int)EUnitFields.UNIT_FIELD_NATIVEDISPLAYID, GetModel(character));         //
            ...
            SetUpdateField<Int32>((int)EUnitFields.UNIT_MOD_CAST_SPEED, 1);// 1065353216);
            ...
            //
            // Equipamento fica aqui
            //

            SetUpdateField<byte>((int)EUnitFields.PLAYER_BYTES_2, Skin.Accessory, 0);
            ...
            SetUpdateField<Int32>((int)EUnitFields.PLAYER_FIELD_COINAGE, 123456);
        }
    }
}
